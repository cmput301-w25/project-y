...
public class AddUpdateDeleteActivityTest {
    ...
    public void addUpdateDeleteMoodEvent() throws InterruptedException {
                ...
                allOf(withId(R.id.etReasonWhyText),
                        childAtPosition(
                                childAtPosition(
                                        ...
                                        0),
                                1)));
        appCompatEditText3.perform(scrollTo(), replaceText("test1"), closeSoftKeyboard());
        ...
        ViewInteraction textView = onView(
                allOf(withId(R.id.text), withText("test1"),
        ...
        ViewInteraction textView2 = onView(
                allOf(withId(R.id.emoticon), withText("( @_@)?"), withContentDescription("Emoticon"),
                        ...
                        isDisplayed()));
        textView2.check(matches(withText("( @_@)?")));
        ...
        ViewInteraction appCompatEditText4 = onView(
                allOf(withId(R.id.updateText), withText("test1"),
                        childAtPosition(
                                childAtPosition(
                                        withClassName(is("android.widget.LinearLayout")),
                                        0),
                                1)));
        appCompatEditText4.perform(scrollTo(), replaceText("test111"));

        ViewInteraction appCompatEditText5 = onView(
                allOf(withId(R.id.updateText), withText("test111"),
                        childAtPosition(
                                childAtPosition(
                                        withClassName(is("android.widget.LinearLayout")),
                                        0),
        ...
        ViewInteraction textView3 = onView(
                allOf(withId(R.id.text), withText("test111"),
                        withParent(withParent(withId(R.id.border))),
                        isDisplayed()));
        textView3.check(matches(withText("test111")));
        ...
        ViewInteraction textView5 = onView(
                allOf(withId(R.id.text), withText("Just because I am testing"),
                        withParent(withParent(withId(R.id.border))),
                        isDisplayed()));
        textView5.check(matches(withText("Just because I am testing")));

        ViewInteraction textView6 = onView(
                allOf(withId(R.id.text), withText("Just because I am testing"),
                        withParent(withParent(withId(R.id.border))),
                        isDisplayed()));
        textView6.check(matches(withText("Just because I am testing")));
    }
